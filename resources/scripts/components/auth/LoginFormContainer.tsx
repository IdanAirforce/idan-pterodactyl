...
const BrandingPanel = () => (
    <div
        css={tw`relative flex flex-col justify-between p-6 md:p-8 lg:p-10 min-h-[220px] lg:min-h-[min(100%,28rem)] lg:w-[42%] shrink-0 overflow-hidden bg-gradient-to-br from-neutral-950 via-neutral-900 to-[#0f0d0c]`}
    >
        ...
        <div css={tw`relative mt-8 lg:mt-0`}>
            <p css={tw`flex items-start gap-2 text-sm text-neutral-400 leading-relaxed max-w-xs`}>
                <svg
                    css={tw`w-5 h-5 text-orange-500 shrink-0 mt-0.5`}
                    viewBox={'0 0 24 24'}
                    fill={'currentColor'}
                    aria-hidden
                >
